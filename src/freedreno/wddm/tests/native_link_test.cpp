...
int main()
{
   auto volatile native_open = &fd_wddm_native_open;
   auto volatile native_submit = &fd_wddm_native_submit;
   ...
   if (!native_open || !native_submit || !render || !device_open || !allocate || !wait || !dispatch ||
